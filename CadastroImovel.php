<?php
   ...
   session_start();
      ...
      // se o usuário estiver logado fara o código abaixo 
   ...
   $metros   = $_POST['metros'];
   $comodos  = strtolower($_POST['comodos']);
   $mobilia  = strtolower($_POST['mobiliado']);
   $valor = ($_POST['valor']);
   ...
   $result = mysqli_query($conexao, "INSERT INTO cad_imovel(situacao, endereco, bairro, cidade, estado, tipoimovel, metroquadrado, qtdcomodos, mobilia, arquivo, valor, data, iduser_fk) 
        values ('$situacao', '$endereco', '$bairro', '$cidade', '$estado', '$tipo', '$metros', '$comodos', '$mobilia', '$novo_nome', $valor,  NOW(), $idfk)");
}
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="CadImovel.css">
...
<body>
 ...
 <header class="header">
       ...
       <img src="logo.PNG" class="iconLogo">
        ...
        <ul class="menuOpcoes">
            <!--<li><a href="#">Home</a></li>
            <li><a href="AreaUsuario.html">Usuário</a></li>
    ...
    <form action="Busca.php" method="GET">
     ...
     <p class="info">Área de Cadastro dos imóveis</p>
     <hr class="hrheader">
    <center>
    <?php
    ...
    ?>
     ...
     <form class="lista" action="CadastroImovel.php" method="POST" enctype="multipart/form-data">

      <!--  <div>
            <h3>Situação</h3>
            <input type="text" name="situacao" maxlength="15" placeholder="Alugado ou disponível?">
        </div> -->

        <div>
            <h3>Endereço</h3>
            <input type="text" name="endereco"  maxlength="70" placeholder="Rua e Nº do imóvel">
            
        </div>

         <div>
            <h3>Bairro</h3>
            <input type="text" name="bairro" maxlength="45" placeholder="Nome do bairro">
            
        </div>

         <div>
            <h3>Cidade</h3>
            <input type="text" name="cidade" maxlength="50" placeholder="Nome da cidade">
             
        </div>

        <div>
            <h3>Estado</h3>
            <input type="text" name="estado" maxlength="40" placeholder="Nome do Estado">
             
        </div>

         <div>
            <h3>Tipo de imóvel</h3>
            <input type="text" name="tipo" maxlength="30" placeholder="Ex: Casa, apartamento, comodos...">
             
        </div>

         <div>
            <h3>Metros quadrados</h3>
            <input type="text" name="metros" placeholder="Ex: 160">
            
        </div>
        <div>
            <h3>Quantos comodos</h3>
            <input type="text" name="comodos" maxlength="60" placeholder="Ex: 1 quarto, 1 sala, 1 banheiro">
            
        </div>
        <div>
            <h3>Mobiliado</h3>
            <input type="text" name="mobiliado" maxlength="80" placeholder="tem mobilia? sim, sofa, tv etc..">

        </div>
        <div>
            <h3>Valor</h3>
            <input type="text" name="valor" maxlength="11" placeholder="preço do aluguel ou diária.">

        </div>
        <div>
            <h3>Fotos imóvel</h3>
            <input type="file" required="" name="arquivo" placeholder="fotos imovel">
        </div>
    ...
    <div class="InfoBloq">
            <h2>Cadastro das informações.</h2>
            <p>Caso o usuário erre algum dado e deseje alterar, é possível editar acessando a área do usuário e dados dos imóveis
            , podendo editar quase todas as informaçoes do imóvel que estão disponíveis.
            Para mais informações vá até a área de contatos ao fim do site.</p>
        </div>
