...
<body>
            ...
            <div class="notification is-danger">
              <h4 style="color: red;">ERRO: Usuário ou senha inválidos.</h4>
            </div>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="login.php" method="POST">
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="text" name="usuario" placeholder="Entre com e-mail">
					...
					<div>
					<br>
						<a href="\Projeto\CadastroProjeto.php" class="cadastro">Cadastre-se</a>
					</div>
