...
<head>
	<meta charset="utf-8">
	<title></title>
    <link rel="stylesheet" type="text/css" href="InfoUsuario.css">
...
<body>
   ...
   <?php
    ...
    <p class="info"><?php echo ucfirst(  $Resultado["nome"]);?>, essas são suas informações pessoais</p>
    ...
    <form class="lista">
        <div>
            <h3>Nome</h3>
            <p><?php echo $Resultado["nome"];
                     echo " ";
                     echo $Resultado["sobrenome"];?></p>
        ...
        <div>
         ...
         <div>
            ...
            <p><?php echo $Resultado["datanasc"];?></p>
            <a href="editar.php?id=<?php echo $Resultado['id'] ?>">Editar</a>
        </div>
    ...
    ?>
        ...
        <div class="InfoBloq">
            ...
            <p>Essas informações nas quais não está habilidado o botao de edição de dados
            não podem ser alteradas devido ao fato de que os dados de identificação únicos, 
            ...
            <div class="footer">
                ...
                <div class="grid-8 footer_contato">
                    ...
                    <div class="grid-8 footer_redes">
                        <h3>Redes sociais</h3>
                        <ul>
                            <li><a href="http://facebook.com" target="_blank" ><img src="facebook.svg" alt="Facebook Bruno"></a></li>
